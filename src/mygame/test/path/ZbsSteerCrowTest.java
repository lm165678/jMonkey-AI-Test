 ...
 * @autor JhonKkk
 */
public class ZbsSteerCrowTest extends FastApp implements ActionListener{
    // 尸群控件
    ...
    public static void main(String[] args) {
        ZbsSteerCrowTest app = new ZbsSteerCrowTest(900, 600, "ZbsSteerCrowTest");
        app.start();
    }

    public ZbsSteerCrowTest(int w, int h, String title) {
        super(w, h, title);
    }
    ...
    public void simpleInitApp() {
        initBulletAppState();
        Node scene = (Node) assetManager.loadModel("Scenes/ZbsSteerCrowScene.j3o");
        
        
        bulletAppState.getPhysicsSpace().add(scene.getChild("scene").getControl(PhysicsControl.class));
...
//        zbsControl.setWalkDisSq(2.5f);
        // 这个值决定距离目标导航点结束时的误差
        navigationControl.setPointDistanceClip(0.2f);
