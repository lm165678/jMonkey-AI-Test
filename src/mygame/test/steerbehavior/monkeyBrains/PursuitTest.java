 ...
 * @author JhonKkk
 */
public class PursuitTest extends FastApp implements ActionListener{
    ...
    public static void main(String[] args) {
        new PursuitTest(900, 600, "PursuitTest(寻求指定目标点)").start();
    }
    public PursuitTest(int w, int h, String title) {
        super(w, h, title);
    }
    ...
    public void simpleInitApp() {
        ...
        pursuitBehavior = new PursuitBehavior(npcAgent, playAgent);
        pursuitBehavior.setVelocity(new Vector3f(0, 0, 0));
        pursuitBehavior.setEnabled(false);
        ...
        simpleMainBehavior.addBehavior(pursuitBehavior);
        //为代理设置主指导行为
        ...
        executor.scheduleAtFixedRate(new Runnable() {
            ...
            public void run() {
                ...
                if(results.size() > 0){
                    ...
                    pursuitBehavior.setEnabled(true);
                }
                else{
