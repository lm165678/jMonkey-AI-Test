 ...
 * @author JhonKkk
 */
public class EvadeTest extends FastApp implements ActionListener{
    ...
    public static void main(String[] args) {
        new EvadeTest(900, 600, "EvadeTest(躲避目标)").start();
    }
    public EvadeTest(int w, int h, String title) {
        super(w, h, title);
    }
    ...
    public void simpleInitApp() {
        initBullet();
        Node scene = (Node) assetManager.loadModel("Scenes/FleeSteerScene.j3o");
        ...
        evadeBehavior = new EvadeBehavior(npcAgent, playAgent);
        evadeBehavior.setVelocity(new Vector3f(1, 1, 1));
        evadeBehavior.setupStrengthControl(10, 0, 10);
        ...
        simpleMainBehavior.addBehavior(evadeBehavior);
        //为代理设置主指导行为
