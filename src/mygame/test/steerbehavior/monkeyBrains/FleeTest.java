 ...
 * @author JhonKkk
 */
public class FleeTest extends FastApp implements ActionListener{
    ...
    public static void main(String[] args) {
        new FleeTest(900, 600, "FleeTest(逃离目标)").start();
    }
    public FleeTest(int w, int h, String title) {
        super(w, h, title);
    }
    ...
    public void simpleInitApp() {
        ...
        fleeBehavior = new FleeBehavior(npcAgent, playAgent);
        fleeBehavior.setVelocity(new Vector3f(1, 1, 1));
        fleeBehavior.setupStrengthControl(10, 0, 10);
        ...
        simpleMainBehavior.addBehavior(fleeBehavior);
        //为代理设置主指导行为
