 ...
 * @author JhonKkk
 */
public class ArriveTest extends FastApp implements ActionListener{
    ...
    public static void main(String[] args) {
        new ArriveTest(900, 600, "ArriveTest(抵到指定位置)").start();
    }
    public ArriveTest(int w, int h, String title) {
        super(w, h, title);
    }
    ...
    public void simpleInitApp() {
        ...
        arriveBehavior = new ArriveBehavior(npcAgent, playAgent);
        arriveBehavior.setVelocity(new Vector3f(1, 1, 1));
        arriveBehavior.setupStrengthControl(10, 0, 10);
        ...
        simpleMainBehavior.addBehavior(arriveBehavior);
        //为代理设置主指导行为
