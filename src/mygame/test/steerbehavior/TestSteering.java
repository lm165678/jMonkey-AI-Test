...
import com.jme3.ai.steering.behaviour.Evade;//规避
import com.jme3.ai.steering.behaviour.Flee;//逃离
import com.jme3.ai.steering.behaviour.ObstacleAvoid;//障碍避免
import com.jme3.ai.steering.behaviour.Persuit;//跟踪
import com.jme3.ai.steering.behaviour.Seek;//寻找
import com.jme3.ai.steering.behaviour.Separation;//分离
 ...
 * @author Lenovo
 */
public class TestSteering extends FastApp {
    ...
    public static void main(String[] args) {
        TestSteering app = new TestSteering(900, 600, "TestSteering");
        app.start();
    }

    public TestSteering(int w, int h, String title) {
        super(w, h, title);
    }
